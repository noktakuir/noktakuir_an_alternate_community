...
d3.linegraph = function(noTicks, noDots, parties, partyColors, partyNames, dataMax, dataMin, additionalMonths) {
    ...
    if (!partyColors) {
        partyColors = {'spd': '#E3000F', 'kpd': '#8B0000', 'ddp': '#DCCA4A', 'z': '#000', 'dvp': '#D5AC27', 'dnvp': '#789922', 'nsdap': '#954B00', 'other': '#a0a0a0'};
    }
    if (!partyNames) {
        partyNames = {'spd': 'NKP', 'kpd': 'DTP', 'ddp': 'SLG', 'z': 'MG', 'dvp': 'LMG', 'dnvp': '4CH', 'nsdap': 'CCJ', 'other': 'Diğerleri'};
    }
    if (!additionalMonths) {
        additionalMonths = 10;
    }
